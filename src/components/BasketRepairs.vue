<template>
  <div class="empty-basket" v-if="data.isBasketEmpty"> 
    ...
    <h2>Your repairs basket is empty</h2>
  </div>
  ...
  <template v-else>
    ...
    <div class="btn-container">
      <Button btnText="Continue" router-link="/basket/confirm/repair" :hasGradient="true" color="secondary" btnFill="solid" expand="block" />
    </div>
  </template>
</template>
